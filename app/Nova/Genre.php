...
class Genre extends Resource
{
    ...
    public function fields(NovaRequest $request)
    {
        return [
            ...
            BelongsTo::make('Parent', resource: self::class)
                ->nullable()
                ->relatableQueryUsing(fn ($request, $query) => $query->whereNull('parent_id'))
                ->help('Specifying a parent indicates that this is a subgenre')
                ->rules('nullable', Rule::exists('genres', 'id')->whereNull('parent_id')),
        ];
    }
